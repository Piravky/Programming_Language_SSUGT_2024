...
| **Вариант** | **Задание**                                                                                                  |
|:-----------:|:-------------------------------------------------------------------------------------------------------------|
|      1      | Напишите программу для вычисления значения выражения `sin(x)` с использованием ряда Тейлора.                 |
|      2      | Напишите программу для вычисления значения выражения `cos(x)` с использованием ряда Тейлора.                 |
|      3      | Напишите программу для вычисления значения выражения `e^x` с использованием ряда Тейлора.                    |
|      4      | Напишите программу для вычисления значения выражения `ln(1+x)` с использованием ряда Тейлора.                |
|      5      | Напишите программу для вычисления значения выражения `arctan(x)` с использованием ряда Тейлора.              |
|      6      | Напишите программу для вычисления значения выражения `(1+x)^n` с использованием биномиальной формулы.        |
|      7      | Напишите программу для вычисления значения выражения `sqrt(x)` с использованием метода Ньютона.              |
|      8      | Напишите программу для вычисления значения выражения `log(x)` с использованием ряда Маклорена для `ln(1+x)`. |
|      9      | Напишите программу для вычисления значения выражения `sin(x)` с использованием ряда Фурье.                   |
|     10      | Напишите программу для вычисления значения выражения `cos(x)` с использованием ряда Фурье.                   |
|     11      | Напишите программу для вычисления значения выражения `exp(x)` с использованием ряда Фурье.                   |
|     12      | Напишите программу для вычисления значения выражения `tan(x)` с использованием ряда Фурье.                   |
|     13      | Напишите программу для вычисления значения выражения `ln(x)` с использованием ряда Фурье.                    |
|     14      | Напишите программу для вычисления значения выражения `sin(x)` с использованием схемы Горнера.                |
|     15      | Напишите программу для вычисления значения выражения `cos(x)` с использованием схемы Горнера.                |
